...
import { XCircle, Loader2, Save, Type, Droplets, CreditCard, AlertCircle, SplitSquareHorizontal, Columns2, Brush, BarChart, Text, Component, Link as LinkIcon, Eye, Sun, Moon } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <SettingsHeader
        icon="Brush"
        title="تخصيص المظهر"
        description="تحكم في كل تفاصيل ألوان وخطوط النظام لتناسب هويتك بشكل كامل"
        color="blue"
      />
