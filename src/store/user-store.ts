...
const initialUsers: User[] = [
    ...
    // Merchants
    { id: 'merchant-1', name: 'جنان صغيرة', email: '0786633891', roleId: 'merchant', avatar: '', password: '123' },
    ...
    { id: 'merchant-6', name: 'سامر الطباخي', email: '0790690352', roleId: 'merchant', avatar: '', password: '123' },
    { id: 'merchant-7', name: 'Stress Killer', email: '0781399935', roleId: 'merchant', avatar: '', password: '123' },
    { id: 'merchant-8', name: 'Brandlet Outlet -1', email: '0776979308', roleId: 'merchant', avatar: '', password: '123' },
    { id: 'merchant-9', name: 'دولي', email: '0793204555', roleId: 'merchant', avatar: '', password: '123' },
    { id: 'merchant-10', name: 'زينة بوتيك', email: '0781223373', roleId: 'merchant', avatar: '', password: '123' },
];
